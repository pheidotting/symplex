...
INSERT INTO GEBRUIKER (SOORT, ID, EMAILADRES, SALT, WACHTWOORD, ACHTERNAAM, TUSSENVOEGSEL, VOORNAAM, ROEPNAAM, BSN, BURGERLIJKESTAAT, GEBOORTEDATUM, GESLACHT, OVERLIJDENSDATUM, KANTOOR, GEBRUIKERSNAAM, BEDRIJF, FUNCTIE, OAUTHTODOIST)

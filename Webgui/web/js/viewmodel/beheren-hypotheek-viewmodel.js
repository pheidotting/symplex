define(['jquery',
    ...
    function ($, commonFunctions, ko, log, redirect, hypotheekMapper, hypotheekService, opmerkingViewModel, bijlageViewModel, menubalkViewmodel, LicentieViewmodel, moment, _) {
        ...
        return function () {
            ...
            this.init = function (hypotheekId, basisId, readOnly, basisEntiteit) {
                ...
                $.when(hypotheekService.lees(hypotheekId, basisEntiteit), hypotheekService.lijstSoortenHypotheek()).then(function (data, lijstSoortenHypotheek) {
                    ...
                    var hypotheek = _.find(data.hypotheken, function (hypotheek) {
                        return hypotheek.identificatie === hypotheekId.identificatie;
                    });
                    if (hypotheek == null) {
                        hypotheek = {
                            'opmerkingen': [],

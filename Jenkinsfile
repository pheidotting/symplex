    ...
    stages {
        ...
        stage ('Deployment Testbak') {
            ...
            steps {
                ...
                '''
                sh "ssh jetty@192.168.91.230 mv /data/web/gui/js/commons/app.js /data/web/gui/js/commons/app_.js"
                sh "ssh jetty@192.168.91.230 sudo sed 's/{VERSION}/${env.BRANCH_NAME}-${env.BUILD_NUMBER}/' /data/web/gui/js/commons/app_.js > /data/web/gui/js/commons/app.js"
            }
            post {
                success {
        ...
        stage ('Deployment Test') {
            ...
            steps {
                ...
                '''
                sh "ssh jetty@192.168.91.215 sed 's/{VERSION}/${env.BRANCH_NAME}-${env.BUILD_NUMBER}/' /data/web/gui/js/commons/app.js"
            }
            post {
                success {
        ...
        stage ('Deployment Live') {
            ...
            steps {
                ...
                '''
                sh "ssh jetty@192.168.91.220 sed 's/{VERSION}/${env.BRANCH_NAME}-${env.BUILD_NUMBER}/' /data/web/gui/js/commons/app.js"
            }
            post {
                success {

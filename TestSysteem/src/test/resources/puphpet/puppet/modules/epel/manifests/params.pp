...
class epel::params {
  ...
  $epel_source_mirrorlist = "https://mirrors.fedoraproject.org/mirrorlist?repo=epel-source-${os_maj_release}
    &arch=\$basearch"
  ...
  $epel_debuginfo_mirrorlist = "https://mirrors.fedoraproject.org/mirrorlist?repo=epel-debug-${os_maj_release}
    &arch=\$basearch"
  ...
  $epel_testing_debuginfo_baseurl = "https://download.fedoraproject.org/pub/epel/testing/${os_maj_release}
    /\$basearch/debug"

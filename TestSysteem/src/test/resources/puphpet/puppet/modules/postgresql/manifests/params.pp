  ...
  case $::osfamily {
    ...
    'Debian': {
      ...
      if $::operatingsystem == 'Debian' and versioncmp($::operatingsystemrelease, '8.0') >= 0 {
        ...
        $service_status = pick($service_status, "/etc/init.d/${service_name}
           status | /bin/egrep -q 'Running clusters: .+|online'")
      }
      $service_reload = "service ${service_name} reload"
    ...
    default: {
      ...
      $err_prefix = "Module ${module_name} does not provide defaults for osfamily: ${::osfamily} operatingsystem: ${
        ::operatingsystem}; please specify a value for ${module_name}::globals::"

...
class apache::params inherits ::apache::version {
  ...
  if $::osfamily == 'RedHat' or $::operatingsystem =~ /^[Aa]mazon$/ {
    ...
    if ($::operatingsystem == 'Ubuntu' and versioncmp($::operatingsystemrelease, '16.04') < 0) or ($::operatingsystem ==
      'Debian' and versioncmp($::operatingsystemrelease, '9') < 0) {
    ...
    $mime_types_config = '/etc/mime.types'
    if ($::operatingsystem == 'Ubuntu' and versioncmp($::operatingsystemrelease, '13.10') >= 0) or ($::operatingsystem
      == 'Debian' and versioncmp($::operatingsystemrelease, '8') >= 0) {
      $docroot = '/var/www/html'
    } else {
      $docroot = '/var/www'
    }
    ...
    if ($::operatingsystem == 'Ubuntu' and versioncmp($::operatingsystemrelease, '14.04') < 0) or ($::operatingsystem ==
      'Debian' and versioncmp($::operatingsystemrelease, '8') < 0) {
      $passenger_root = '/usr'

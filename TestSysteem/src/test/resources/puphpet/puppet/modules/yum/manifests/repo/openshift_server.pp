...
#
class yum::repo::openshift_server (
  $version = 4
) {
  ...
  yum::managed_yumrepo { 'openshift-origin':
    ...
    baseurl        => "https://mirror.openshift.com/pub/origin-server/release/${version}/rhel-6/packages/${
      ::architecture}",
    enabled        => 1,
    gpgcheck       => 0,
  ...
  yum::managed_yumrepo { 'openshift-deps':
    ...
    baseurl        => "https://mirror.openshift.com/pub/origin-server/release/${version}/rhel-6/dependencies/${
      ::architecture}",
    enabled        => 1,
    gpgcheck       => 0,
    failovermethod => 'priority',
